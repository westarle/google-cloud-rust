...
impl super::stub::ReachabilityService for ReachabilityService {
    async fn list_connectivity_tests(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/connectivityTests";
        ...
        let options = {
            ...
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//networkmanagement.googleapis.com/{}", rn);
    ...
    async fn get_connectivity_test(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/global/connectivityTests/"), Segment::SingleWildcard])?,
            );
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    ...
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/global/connectivityTests/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn update_connectivity_test(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.resource.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/global/connectivityTests/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{resource.name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.resource.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/global/connectivityTests/"), Segment::SingleWildcard],
                    "resource.name",
                    "projects/*/locations/global/connectivityTests/*");
                paths.push(builder.build());
    ...
    async fn set_iam_policy(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}:setIamPolicy",
                try_match(Some(&req).map(|m| &m.resource).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/global/connectivityTests/"), Segment::SingleWildcard])?,
            );
    ...
    async fn list_operations(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/operations",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/global")])?,
            );
...
impl super::stub::VpcFlowLogsService for VpcFlowLogsService {
    async fn list_vpc_flow_logs_configs(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}/vpcFlowLogsConfigs";
    ...
    async fn get_vpc_flow_logs_config(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/vpcFlowLogsConfigs/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/vpcFlowLogsConfigs/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn create_vpc_flow_logs_config(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                .or(Some(&req.parent))
                                .or(Some(&req.vpc_flow_logs_config_id))
                ;
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//networkmanagement.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
        ...
        let builder = builder
                .query(&[("$alt", "json;enum-encoding=int")])
                .header("x-goog-api-client", reqwest::header::HeaderValue::from_static(&info::X_GOOG_API_CLIENT_HEADER));
        let body = gaxi::http::handle_empty(req.vpc_flow_logs_config, &method);
        self.inner.execute(
            builder,
            body,
            options,
    ...
    async fn update_vpc_flow_logs_config(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.vpc_flow_logs_config.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/vpcFlowLogsConfigs/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{vpc_flow_logs_config.name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.vpc_flow_logs_config.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/vpcFlowLogsConfigs/"), Segment::SingleWildcard],
    ...
    async fn query_org_vpc_flow_logs_configs(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/vpcFlowLogsConfigs:queryOrgVpcFlowLogsConfigs",
                try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{parent}/vpcFlowLogsConfigs:queryOrgVpcFlowLogsConfigs";
    ...
    async fn show_effective_flow_logs_configs(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/vpcFlowLogsConfigs:showEffectiveFlowLogsConfigs",
                try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{parent}/vpcFlowLogsConfigs:showEffectiveFlowLogsConfigs";

            let builder = self
                .inner
                .builder(reqwest::Method::GET, path);
            let builder = builder.query(&[("resource", &req.resource)]);
            let builder = builder.query(&[("pageSize", &req.page_size)]);
            let builder = builder.query(&[("pageToken", &req.page_token)]);
            let builder = builder.query(&[("filter", &req.filter)]);
            let builder = Ok(builder);
...
/// Implements [OrganizationVpcFlowLogsService](super::stub::OrganizationVpcFlowLogsService) using a [gaxi::http::ReqwestClient].
#[derive(Clone)]
pub struct OrganizationVpcFlowLogsService {
    inner: gaxi::http::ReqwestClient,
}

impl std::fmt::Debug for OrganizationVpcFlowLogsService {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::result::Result<(), std::fmt::Error> {
        f.debug_struct("OrganizationVpcFlowLogsService")
            .field("inner", &self.inner)
            .finish()
    }
}
...
impl super::stub::OrganizationVpcFlowLogsService for OrganizationVpcFlowLogsService {
    async fn list_vpc_flow_logs_configs(
        &self,
        req: crate::model::ListVpcFlowLogsConfigsRequest,
        options: gax::options::RequestOptions,
    ...
    async fn get_vpc_flow_logs_config(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("organizations/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/vpcFlowLogsConfigs/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("organizations/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/vpcFlowLogsConfigs/"), Segment::SingleWildcard],
                    "name",
    ...
    async fn update_vpc_flow_logs_config(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.vpc_flow_logs_config.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("organizations/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/vpcFlowLogsConfigs/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{vpc_flow_logs_config.name}";
