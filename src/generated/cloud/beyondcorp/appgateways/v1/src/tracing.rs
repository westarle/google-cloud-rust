...
where T: super::stub::AppGatewaysService + std::fmt::Debug + Send + Sync {
    ...
    async fn list_app_gateways(
        ...
        let result = self.inner.list_app_gateways(req, options)
    ...
    async fn get_app_gateway(
        ...
        let result = self.inner.get_app_gateway(req, options)
            .instrument(client_request_span.clone()).await;
    ...
    async fn create_app_gateway(
        ...
        let result = self.inner.create_app_gateway(req, options)
            .instrument(client_request_span.clone()).await;
    ...
    async fn delete_app_gateway(
        ...
        let result = self.inner.delete_app_gateway(req, options)
            .instrument(client_request_span.clone()).await;
