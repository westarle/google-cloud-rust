...
impl super::stub::Lineage for Lineage {
    async fn process_open_lineage_run_event(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{parent}:processOpenLineageRunEvent";
        ...
        let body = gaxi::http::handle_empty(req.open_lineage, &method);
        self.inner.execute(
            builder,
            body,
            options,
    ...
    async fn create_process(
        ...
        let options = {
            ...
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//datalineage.googleapis.com/{}", rn);
    ...
    async fn update_process(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.process.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard])?,
            );
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.process.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard],
                    "process.name",
    ...
    async fn get_process(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard])?,
            );
    ...
    async fn create_run(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/runs",
                try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard])?,
            );
        ...
        let builder = builder
                .query(&[("$alt", "json;enum-encoding=int")])
                .header("x-goog-api-client", reqwest::header::HeaderValue::from_static(&info::X_GOOG_API_CLIENT_HEADER));
        let body = gaxi::http::handle_empty(req.run, &method);
        self.inner.execute(
            builder,
            body,
            options,
    ...
    async fn update_run(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).and_then(|m| m.run.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard, Segment::Literal("/runs/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{run.name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.run.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard, Segment::Literal("/runs/"), Segment::SingleWildcard],
                    "run.name",
    ...
    async fn get_run(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard, Segment::Literal("/runs/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
    ...
    async fn create_lineage_event(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}/lineageEvents",
                try_match(Some(&req).map(|m| &m.parent).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard, Segment::Literal("/runs/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{parent}/lineageEvents";
        ...
        let builder = builder
                .query(&[("$alt", "json;enum-encoding=int")])
                .header("x-goog-api-client", reqwest::header::HeaderValue::from_static(&info::X_GOOG_API_CLIENT_HEADER));
        let body = gaxi::http::handle_empty(req.lineage_event, &method);
        self.inner.execute(
            builder,
            body,
            options,
    ...
    async fn get_lineage_event(
        ...
        .or_else(|| {
            let path = format!(
                "/v1/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard, Segment::Literal("/runs/"), Segment::SingleWildcard, Segment::Literal("/lineageEvents/"), Segment::SingleWildcard])?,
            );
            let path_template = "/v1/{name}";
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    Some(&req).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/processes/"), Segment::SingleWildcard, Segment::Literal("/runs/"), Segment::SingleWildcard, Segment::Literal("/lineageEvents/"), Segment::SingleWildcard],
                    "name",
