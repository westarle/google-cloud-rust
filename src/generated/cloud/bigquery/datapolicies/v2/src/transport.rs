...
impl super::stub::DataPolicyService for DataPolicyService {
    async fn create_data_policy(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                .or(Some(&req.parent))
                                .or(req.data_policy.as_ref().map(|s| &s.policy_tag))
                ;
    ...
    async fn add_grantees(
        ...
        .or_else(|| {
            let path = format!(
                "/v2/{}:addGrantees",
                try_match(Some(&req).map(|m| &m.data_policy).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/dataPolicies/"), Segment::SingleWildcard])?,
            );
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                ...
                let builder = builder.maybe_add(
                    ...
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/dataPolicies/"), Segment::SingleWildcard],
                    "data_policy",
    ...
    async fn update_data_policy(
        ...
        .or_else(|| {
            let path = format!(
                "/v2/{}",
                try_match(Some(&req).and_then(|m| m.data_policy.as_ref()).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/dataPolicies/"), Segment::SingleWildcard])?,
            );
        ...
        .ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                let builder = builder.maybe_add(
                    Some(&req).and_then(|m| m.data_policy.as_ref()).map(|m| &m.name).map(|s| s.as_str()),
                    &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/dataPolicies/"), Segment::SingleWildcard],
                    "data_policy.name",
                    "projects/*/locations/*/dataPolicies/*");
                paths.push(builder.build());
    ...
    async fn delete_data_policy(
        ...
        .or_else(|| {
            let path = format!(
                "/v2/{}",
                try_match(Some(&req).map(|m| &m.name).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/dataPolicies/"), Segment::SingleWildcard])?,
            );
    ...
    async fn get_iam_policy(
        ...
        .or_else(|| {
            let path = format!(
                "/v2/{}:getIamPolicy",
                try_match(Some(&req).map(|m| &m.resource).map(|s| s.as_str()), &[Segment::Literal("projects/"), Segment::SingleWildcard, Segment::Literal("/locations/"), Segment::SingleWildcard, Segment::Literal("/dataPolicies/"), Segment::SingleWildcard])?,
            );
