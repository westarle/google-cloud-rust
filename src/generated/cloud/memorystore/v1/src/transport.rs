...
impl super::stub::Memorystore for Memorystore {
    async fn list_instances(
        ...
        let options = {
            ...
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//memorystore.googleapis.com/{}", rn);
    ...
    async fn create_instance(
        ...
        let options = {
            let resource_name = Option::<&String>::None
                .or(Some(&req.parent))
                                .or(req.instance.as_ref().and_then(|s| s.backup_collection.as_ref()))
                ;
            if let Some(rn) = resource_name {
                let full_resource_name = format!("//memorystore.googleapis.com/{}", rn);
                gax::options::internal::set_resource_name(options, full_resource_name)
    ...
    async fn get_certificate_authority(
        ...
        .or_else(|| {
            ...
            let path_template = "/v1/{name}/certificateAuthority";
