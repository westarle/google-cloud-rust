...
mod tests {
    ...
    async fn execute_streaming_308() -> TestResult {
        ...
        server.expect(
            ...
            .respond_with(httptest::responders::status_code(308).append_header("Location", "/new-location").body("Resume Incomplete")),
        );
        ...
        let result = client.execute_streaming_once(builder, options, None, 0).await;
